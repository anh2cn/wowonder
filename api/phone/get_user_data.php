...
if ($type == 'get_user_data') {
    ...
    if (empty($json_error_data)) {
        ...
        if (empty($user_login_data)) {
            ...
            $user_profile_data['post_count']         = Wo_CountUserPosts($user_profile_data['user_id']);
            ...
            $user_profile_data['following_number']   = Wo_CountFollowing($user_profile_data['user_id']);
            $user_profile_data['followers_number']   = Wo_CountFollowers($user_profile_data['user_id']);
            $user_profile_data['followers']          = Wo_GetFollowing($user_profile_data['user_id']);
            $user_profile_data['pages']              = Wo_GetLikes($user_profile_data['user_id']);
